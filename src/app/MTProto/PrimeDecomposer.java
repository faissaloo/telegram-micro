...
public class PrimeDecomposer {
  ...
  public static long finite_ring(long current_value, Integer128 big_limit, Integer128 negated_big_limit, long limit, Integer128 multiplication_scratch, Integer128 modulo_scratch) {
    return multiplication_scratch
      .set_unsigned_long_multiply(current_value, current_value)
      .fast_unsigned_modulo(big_limit, negated_big_limit, modulo_scratch)
      .mutating_add()
  ...
  public static Coprimes decompose(long to_factorise) {
    if (to_factorise % 2 == 0) {
      ...
      Integer128 negated_big_to_factorise = big_to_factorise.negate();
      ...
      while (nontrivial_denominator == 1L) {
        ...
        for (long i = 0L; i < search_range; i++) {
          fast_pointer = finite_ring(fast_pointer, big_to_factorise, negated_big_to_factorise, to_factorise, multiplication_scratch, modulo_scratch);
        }
        already_searched = 0L;
